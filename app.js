jQuery(function($){
    const launch = new Date(2022, 11, 06, 00, 00, 00);
    const stop = new Date(2022, 11, 07, 00, 00, 00);
    const days = $('#days');
    const dd = $('#dd');
    const hours = $('#hours');
    const hh = $('#hh');
                ...
                <div class="container bg-primary text-light">
                    <div class="row">
                        <div class="header justify-content-center">
                            ...
                            <p class="text-center mb-2">Vous êtes entrain de visiter mon site d'anniversaire en retard cher ami. Mon anniversaire viens de prendre fin depuis le 06 décembre 2022 à 23:59:59.</p>
                            <p class="text-center mb-3">Conservez ce même lien pour mon anniversaire à l'année prochaine prévu le 06 décembre 2023.</p>
                        </div>
